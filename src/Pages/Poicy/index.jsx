    ...
    return (
        <div className={cls.policyContainer}>
            ...
            <p className={cls.title_two}>
                ...
                используем, защищаем и раскрываем информацию, 
            ...
            <p className={cls.title_three}>
                ...
                Мы собираем только ту информацию, которую вы сознательно 
                предоставляете нам, например, 
                при заполнении формы подписки на новости или оставлении 
                комментария. Это может включать ваше имя, 
            ...
            <p className={cls.title_four}>
                ...
                связанных с предоставлением новостной информации, 
                общения с вами и улучшения 
                пользовательского опыта нашего сайта. 
                Мы не продаем, не арендуем и не передаем вашу
                информацию третьим сторонам без вашего явного согласия, 
            ...
            <p className={cls.title_five}>
                ...
                Мы применяем технические и организационные меры безопасности,
                 чтобы обеспечить сохранность ваших данных.
            </p>
            ...
            <p className={cls.title_six}>
                ...
                Мы можем использовать файлы cookie, чтобы улучшить ваш 
                опыт использования нашего сайта.
                Файлы cookie являются небольшими текстовыми файлами, 
                которые сохраняются на вашем устройстве
                и позволяют нам анализировать ваше взаимодействие 
                с сайтом, предоставлять персонализированный 
                контент и запоминать ваши предпочтения. Вы можете 
                отключить файлы cookie в настройках своего браузера, 
            ...
            <p className={cls.title_seven}>
                ...
                которые имеют 
                свои собственные политики конфиденциальности.
                 Мы не несем ответственности за содержание и 
                действия этих внешних сайтов. Рекомендуется 
                ознакомиться с их политикой конфиденциальности 
            ...
            <p className={cls.title_nine}>
                Если у вас возникнут вопросы или требуется дополнительная
            ...
            <p className={cls.title_ten}>
                Мы ценим ваше доверие и гарантируем, что ваша 
