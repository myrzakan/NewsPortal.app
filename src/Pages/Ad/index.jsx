  ...
  return (
    ...
    >
      ...
      <p className="title3 text-xl max-x6:text-[15px]">
        ...
        внимание пользователей. Мы предлагаем разные размеры и позиции баннеров
        для оптимальной видимости и привлекательности.
      </p>
      ...
      <p className="title5 text-xl max-x6:text-[15px]">
        <strong className="text-[var(--color-text-base)]">Видеореклама:</strong>{' '}
        <br />
      ...
      <p className="title7 text-xl max-x6:text-[15px]">
        ...
        специальные рекламные пакеты, отвечающие вашим уникальным потребностям и
        бюджету.
      </p>
      ...
      <p className="title8 text-xl max-x6:text-[15px]">
        ...
        обсудить возможности сотрудничества и начать успешную рекламную кампанию
        на
        <strong className="text-[var(--color-text-base)]"> News Line</strong>.
      </p>
