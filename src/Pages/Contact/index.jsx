  ...
  return (
    ...
    >
      ...
      <p className="title1 text-xl max-x6:text-[15px]">
        ...
        общаться с вами и помочь вам в любых вопросах, связанных с проектом
      ...
      <p className="title2 text-xl max-x6:text-[15px]">
        ...
        связаться с нами. Мы готовы ответить на ваши вопросы и предоставить вам
      ...
      >
        ...
        <strong className="text-[var(--color-text-base)]">news@line.kg</strong>
      </p>
      ...
      >
        ...
        <strong className="text-[var(--color-text-base)]">г. Бишкек</strong>
      </p>
      ...
      <p className="title8 text-xl max-x6:text-[15px]">
        ...
        <strong className="text-[var(--color-text-base)]"> "News Line"</strong>,
        мы будем рады рассмотреть ваше предложение. Присылайте свои материалы на
        указанный выше email, и наша редакционная команда рассмотрит их с
        интересом.
      </p>
