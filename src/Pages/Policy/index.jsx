  ...
  return (
    <div className="container">
      <div className="content">
        <h1 className="Title">Политика конфиденциальности News Line:</h1>
        ...
        <p className="title2">
          ...
          предоставляете нам, например, при заполнении формы подписки на новости
          или оставлении комментария. Это может включать ваше имя, адрес
          электронной почты или другую персональную информацию.
        </p>
        ...
        <p className="title3">
          ...
          передаем вашу информацию третьим сторонам без вашего явного согласия,
        ...
        <p className="title5">
          ...
          использования нашего сайта. Файлы cookie являются небольшими
          текстовыми файлами, которые сохраняются на вашем устройстве и
          позволяют нам анализировать ваше взаимодействие с сайтом,
          предоставлять персонализированный контент и запоминать ваши
          предпочтения. Вы можете отключить файлы cookie в настройках своего
        ...
        <p className="title7">
          ...
          странице, и вы будете уведомлены о важных изменениях, если это
          требуется по закону.
        </p>
